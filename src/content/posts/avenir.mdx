...
<script>import FontSample from '$components/blog-widgets/FontSample.svelte';</script>
...
<div class="full-bleed not-prose">
	<FontSample
		fontName="Outfit"
		fontSrc="https://api.fontshare.com/v2/css?f[]=outfit@1&display=swap"
		wordTest="Üllői űrhájó"
	/>
</div>
...
<div class="full-bleed not-prose">
	<FontSample
		...
		fontSrc="https://fonts.cdnfonts.com/css/century-gothic"
		wordTest="BALLOON"
	/>
</div>
