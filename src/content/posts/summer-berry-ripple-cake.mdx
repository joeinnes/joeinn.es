...
- 250&nbsp;grams&nbsp;good white chocolate, chopped
- 200&nbsp;grams&nbsp;frozen raspberries
- 150&nbsp;grams&nbsp;plain flour
...
1. **Prepare each layer:** Starting with the first disk, brush generously with the cooled syrup. Spread with the mascarpone cream mixture, drizzle the compôte over it, and lay flat slices of macerated strawberry on top. Once done, place the next disc and begin work immediately. You should aim to use
